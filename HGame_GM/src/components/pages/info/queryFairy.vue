...
<template>
  <div class="list-lb">
    ...
    <!--表格-->
    <div class="table">
      <el-table ref="multipleTable" :data="tableDatas" border style="width: 100%;margin-bottom: 20px;">
        <el-table-column prop="heroId" label="精灵ID" align='center'>
        </el-table-column>
        <el-table-column prop="heroName" label="精灵名字" align='center'>
        </el-table-column>
        <el-table-column prop="num" label="拥有人数" align='center'>
        </el-table-column>
      </el-table>
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="paginations.pageCurrent" :page-sizes="paginations.pageSizes" :page-size="paginations.pageSize" :layout="paginations.layout" :total="paginations.pageNum">
      </el-pagination>
    </div>
  </div>
</template>
