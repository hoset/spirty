...
export default {
  ...
  methods: {
    reloadActivity() {
      ...
      this.apiList4._get_(window.apiUrl.api_reloadFlashSale, this.seachParams, (e) => this.$Message.error("操作失败：" + e), (e) => {
    ...
    updateOrCreate() {
      this.apiList4._postj_(window.apiUrl.api_addOrUpdateFlashSale, this.formData, (e) => this.$Message.error("操作失败：" + e), (e) => {
        this.$Message.success("操作成功");
    ...
    queryItems() {
      ...
      this.apiList4._get_(window.apiUrl.api_FlashSale, check(this.seachParams), (e) => console.log(e), (e) => this.datas = e);
    },
    validateSeachParam() {
