    ...
    <Row>
      <Col>
        <Card>
          ...
          <!--表格头部搜索功能-->
          <Row :gutter="8" class="rows-style">
            <Col span="4">
              <div class="sels-div">
                <span>日期：</span>
                <DatePicker class="sel-date" type="date" show-week-numbers placeholder="Select date" style="width: 200px"></DatePicker>
              </div>
            </Col>
            <Col span="4">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getData (params) {
        this.loading2 = true
        this.apiList.orderList(params).then((res) => {
          if (!res.error) {
